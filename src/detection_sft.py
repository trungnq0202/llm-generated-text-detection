...
from data_loader.detection_sft import AiDataset, AiCollator, AiCollatorTrain, show_batch
from models import LlamaForDetectAI, MistralForDetectAI, PhiForDetectAI
from optimizer import get_optimizer
from utils import compute_metrics, as_minutes, get_lr, AverageMeter
...
@hydra.main(version_base=None, config_path="config/detection_sft", config_name="detection_sft")
def train(cfg):
    ...
    essay_df = pd.read_csv(os.path.join(data_dir, "train_essays_v2.csv"))

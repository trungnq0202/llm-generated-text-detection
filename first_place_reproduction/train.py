...
from dataloader import AiCollator, AiCollatorTrain, show_batch
from model import (LlamaForDetectAI, MistralForDetectAI,
                                PhiForDetectAI)
from optimizer import get_optimizer
from utils import AverageMeter, as_minutes, get_lr, compute_metrics
...
@hydra.main(version_base=None, config_path="configs", config_name="conf_r_detect")
def train(cfg):
    # ------- Accelerator ---------------------------------------------------------------#
    if cfg.use_wandb:
